...
Sets up emulator, creates all handler instances, runs the 60fps game loop processing keyboard input, voice command durations, and auto-tracking commands in priority order.
